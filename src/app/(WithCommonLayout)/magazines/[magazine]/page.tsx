        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="lg:w-1/3">
              <div className="bg-linear-to-br from-cyan-500/20 to-purple-500/20 rounded-2xl border border-slate-700/50 p-8 aspect-3/4 flex items-center justify-center">
            ...
            <div className="lg:w-2/3">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-4 bg-linear-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
                James Webbs First Year: Revolutionizing Astronomy
              </h1>

              <p className="text-cyan-300 text-xl mb-6">
                Unveiling the mysteries of the early universe through groundbreaking observations
              </p>

              <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                A comprehensive collection of research articles and discoveries from the James Webb Space Telescopes inaugural year, featuring deep field observations, exoplanet atmospheric studies, and revolutionary insights into cosmic evolution.
              </p>

              {/* Key Outcomes */}
              <div className="mb-6">
                <h3 className="text-cyan-400 text-lg font-semibold mb-3">Key Outcomes:</h3>
          ...
          <div className="group bg-slate-800/30 backdrop-blur-lg rounded-2xl overflow-hidden border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/10">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-300 text-sm mb-4 line-clamp-2">
                Reconstructing the history of the universe from the first galaxies to present day.
              </p>
